...
<body>
            ...
            <div class="total-payment-details">
                ...
                <div class="details-box">
                    <select id="batch-filter">
                        ...
                        <option value="BBA23">BBA</option>
                        <option value="BCA23">BCA</option>
                        <option value="BSC23">B.Sc CS(H)</option>
                    </select>
                </div>
            </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const selectedYear = localStorage.getItem('selectedYear2023');
            if (selectedYear) {
        ...
        function selectYear(year) {
            localStorage.setItem('selectedYear2023', year); //############ TO BE CHANGED #############
            fetchData(year);
            ...
            fetch('batch-payment-data.php')
                ...
                .then(data => {
                    const filteredData = data.filter(row => {
                        const rollNo = row.ID;
                        return rollNo.includes("03BCA23") || rollNo.includes("03BSC23") || rollNo.includes("03BBA23");
                    }); //############ TO BE CHANGED #############
        ...
        function exportTableToExcel() {
            ...
            XLSX.writeFile(workbook, '2023-Batch-Data.xlsx'); //############ TO BE CHANGED #############
        }
    </script>
</body>
